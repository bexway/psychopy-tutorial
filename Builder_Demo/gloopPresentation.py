...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), May 10, 2016, at 22:48
...
instructions = visual.TextStim(win=win, ori=0, name='instructions',
    text=u'Press f for yes and j for no',    font=u'Arial',
...
for thisTrial in trials:
    ...
    sentPrompt.setText("Gloop of the sphere is " + sphereColor)
